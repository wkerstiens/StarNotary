...
contract StarNotary is ERC721 {
    ...
    constructor () ERC721 ("WAK's Star Notary", "WAK")  public {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require (ownerOfToken1 == msg.sender || ownerOfToken2 == msg.sender, "The sender must own one of the tokens");
        require (ownerOfToken1 != ownerOfToken2, "You cannot exchange tokens with yourself");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address ownerOfToken1 = ownerOf(_tokenId);
        require(msg.sender == ownerOfToken1, "Message sender must be the owner of the toker");
